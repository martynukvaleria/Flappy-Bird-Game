...
PillarItem::PillarItem():
    topPillar(new QGraphicsPixmapItem(QPixmap("/home/martynuk/Desktop/labs/lab-flappybird/images/pipe.jpg"))),
    bottomPillar(new QGraphicsPixmapItem(QPixmap("/home/martynuk/Desktop/labs/lab-flappybird/images/pipe.jpg"))),
    pastBird(false){
